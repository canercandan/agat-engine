...
$l['error_uploadfailed_php6'] = "PHP a retourné : Un dossier temporaire est manquant. Veuillez contacter l'administrateur du forum avec cette erreur.";
$l['error_uploadfailed_php7'] = "PHP a retourné : Impossible d'écrire le fichier sur le disque. Veuillez contacter l'administrateur du forum avec cette erreur.";
...
La raison que l'utilisateur a donné pour ce signalement :
{7}

Ce message a été envoyé à tous les modérateurs de ce forum, ou tous les administrateurs et super modérateurs, s'il n'y a pas de modérateurs.
...
Un ou plusieurs utilisateurs ont tenté de vous envoyer un message privé, mais il s'avère que ces message n'a pas pu être transmis.
