...
if(isset($_GET['valid']) == false && isset($_GET['form']) == false)
    ...
    foreach ($tab as $item)
        ...
        echo '</td>
            <td>
                <a href="index.php?form=edit&id='.$id.'">Modifier</a>
                <a href="index.php?form=remove&id='.$id.'">Supprimer</a>
            </td>
        </tr>';
        }
    echo '</tbody></table>
    ...
    if (isset($_GET['id']) == true && $form == 'edit')
        ...
        echo '<form action="index.php?valid=edit" method="post">
        ...
        echo '</td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="submit" value="Mettre &agrave; jour"/> <a href="index.php?">Annuler</a></td>
                </tr>
            </tbody>
        </table>
        </form>';
    ...
    #ADD_GROUP
        ...
        {
        echo '<form action="index.php?valid=add" method="post">
        <table class="userTable">
        ...
        echo '</td>
                ...
                <tr>
                    <td>&nbsp;<td/>
                    <td><input type="submit" value="Cr&eacute;er un groupe"/> <a href="index.php?">Annuler</a></td>
                </tr>
            </tbody>
        </table>
        </form>';
    ...
    #DELETE_GROUP
        ...
        $id = $_GET['id'];
        list($name, $rights) = getGroup($id);
        echo '<form action="index.php?valid=remove" method="post">
            <input type="hidden" name="id" value="'.$id.'"/>
            <table class="userTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>&nbsp;<td/>
                        <td>
                            <input type="submit" value="Supprimer"/> <a href="index.php?">Annuler</a>
                        </td>
                    </tr>
                </tbody>
            </table>
